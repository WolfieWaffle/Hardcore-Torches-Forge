...
public class BlockInit {
    ...
    public static final RegistryObject<Block> LIT_SOUL_TORCH = BLOCKS.register("lit_soul_torch", () -> new HardcoreFloorTorchBlock(Block.Properties.of().mapColor(MapColor.NONE).pushReaction(PushReaction.DESTROY).noCollission().instabreak().lightLevel((state) -> 10).sound(SoundType.WOOD).noOcclusion(), ParticleTypes.SOUL_FIRE_FLAME, ETorchState.LIT, MainMod.soulTorches, () -> Config.defaultSoulTorchFuel.get()));
    ...
    public static final RegistryObject<Block> UNLIT_SOUL_TORCH = BLOCKS.register("unlit_soul_torch", () -> new HardcoreFloorTorchBlock(Block.Properties.of().mapColor(MapColor.NONE).pushReaction(PushReaction.DESTROY).noCollission().instabreak().sound(SoundType.WOOD).noOcclusion(), null, ETorchState.UNLIT, MainMod.soulTorches, () -> Config.defaultSoulTorchFuel.get()));
