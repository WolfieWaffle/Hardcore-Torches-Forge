...
public class BlockInit {
    ...
    public static final RegistryObject<Block> LIT_SOUL_LANTERN = BLOCKS.register("lit_soul_lantern", () -> new SoulLanternBlock(Block.Properties.of().mapColor(MapColor.NONE).pushReaction(PushReaction.DESTROY).instabreak().lightLevel((state) -> SoulLanternBlock.SOUL_LANTERN_LIGHT_LEVEL).sound(SoundType.LANTERN).noOcclusion(), true, () -> Config.defaultSoulLanternFuel.get()));
    public static final RegistryObject<Block> UNLIT_SOUL_LANTERN = BLOCKS.register("unlit_soul_lantern", () -> new SoulLanternBlock(Block.Properties.of().mapColor(MapColor.NONE).pushReaction(PushReaction.DESTROY).instabreak().sound(SoundType.LANTERN).noOcclusion(), false, () -> Config.defaultSoulLanternFuel.get()));
