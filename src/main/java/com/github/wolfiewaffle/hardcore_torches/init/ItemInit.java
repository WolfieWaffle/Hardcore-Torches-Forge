...
public class ItemInit {
    ...
    public static final RegistryObject<Item> FIRE_STARTER = ITEMS.register("fire_starter", () -> new FireStarterItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final RegistryObject<Item> LIT_LANTERN = ITEMS.register("lit_lantern", () -> new BasicLanternItem(BlockInit.LIT_LANTERN.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final RegistryObject<Item> UNLIT_LANTERN = ITEMS.register("unlit_lantern", () -> new BasicLanternItem(BlockInit.UNLIT_LANTERN.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));

    public static final RegistryObject<Item> LIT_SOUL_LANTERN = ITEMS.register("lit_soul_lantern", () -> new SoulLanternItem(BlockInit.LIT_SOUL_LANTERN.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final RegistryObject<Item> UNLIT_SOUL_LANTERN = ITEMS.register("unlit_soul_lantern", () -> new SoulLanternItem(BlockInit.UNLIT_SOUL_LANTERN.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
}
