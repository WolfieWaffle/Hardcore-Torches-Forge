...
@net.minecraftforge.fml.common.Mod("hardcore_torches")
public class Mod
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("hardcore_torches", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
